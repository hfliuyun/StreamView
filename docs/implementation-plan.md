...
- 2026-08-23：完成 Task P5j-3b 扩展 —— 分帧归属事实随 `stsd` 绑定一并采集（`Mp4SampleDescriptionBinding` 增补 `configurationNode` 与 `prefixLengthBytes`）：
